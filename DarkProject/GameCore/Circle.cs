...
namespace ChosenUndead
{
    public struct Circle
    {
        ...
        public int Left { get => (int)Center.X - Radius; }

        public int Right { get => (int)Center.X + Radius; }

        public int Top { get => (int)Center.Y - Radius; }

        public int Bottom { get => (int)Center.Y + Radius; }
